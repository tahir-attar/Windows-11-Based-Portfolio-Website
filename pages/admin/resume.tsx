...
const SKILL_ICONS = [
  {
    label: 'JavaScript',
    url: '/assets/portfolio/skills/javascript-original.svg',
  },
  {
    label: 'TypeScript',
    url: '/assets/portfolio/skills/typescript-original.svg',
  },
  ...
  { label: 'Software Testing', url: '/assets/portfolio/skills/developer.png' },
  {
    ...
    url: '/assets/portfolio/skills/responsive.png',
  },
  ...
  {
    label: 'PostgreSQL',
    url: '/assets/portfolio/skills/postgresql-original.svg',
  },
  ...
  {
    label: 'Keras',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/keras/keras-original.svg',
  },
  {
    label: 'Jupyter',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/jupyter/jupyter-original.svg',
  },
  {
    label: 'NumPy',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/numpy/numpy-original.svg',
  },
  {
    label: 'Pandas',
  ...
  {
    label: 'Kaggle',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/kaggle/kaggle-original.svg',
  },
  ...
  { label: 'ONNX', url: 'https://cdn.simpleicons.org/onnx/717272' },
  {
    ...
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/apacheairflow/apacheairflow-original.svg',
  },
  {
    label: 'Apache Spark',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/apachespark/apachespark-original.svg',
  },
  {
    label: 'Apache Hadoop',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/hadoop/hadoop-original.svg',
  },
  {
    label: 'Apache Kafka',
  ...
  { label: 'Tableau', url: '/assets/portfolio/skills/Tableau.svg' },
  { label: 'Power BI', url: '/assets/portfolio/skills/PowerBI.svg' },
  {
    label: 'Bootstrap',
  ...
  {
    label: 'jQuery',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/jquery/jquery-original.svg',
  },
  {
    label: 'Gatsby',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/gatsby/gatsby-original.svg',
  },
  {
    label: 'Nuxt.js',
  ...
  {
    label: 'D3.js',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/d3js/d3js-original.svg',
  },
  {
    label: 'GitLab',
  ...
  {
    label: 'ESLint',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/eslint/eslint-original.svg',
  },
  ...
  {
    label: 'Ember.js',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/ember/ember-original.svg',
  },
  {
    label: 'Redis',
  ...
  {
    label: 'CouchDB',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/couchdb/couchdb-original.svg',
  },
  {
    label: 'MariaDB',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mariadb/mariadb-original.svg',
  },
  {
    label: 'SQLite',
  ...
  { label: 'Streamlit', url: 'https://cdn.simpleicons.org/streamlit/FF4B4B' },
  {
    ...
    url: 'https://cdn.simpleicons.org/weightsandbiases/FFBE00',
  },
  ...
  { label: 'Seaborn', url: '/assets/portfolio/skills/Seaborn.svg' },
  { label: 'XGBoost', url: '/assets/portfolio/skills/XGBoost.svg' },
  ...
  { label: 'Looker', url: 'https://cdn.simpleicons.org/looker/4285F4' },
  {
    ...
    url: 'https://cdn.simpleicons.org/apachesuperset/20A7C9',
  },
  {
  ...
  {
    label: 'CircleCI',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/circleci/circleci-plain.svg',
  },
  {
  ...
  {
    label: 'OpenShift',
    url: 'https://cdn.simpleicons.org/redhatopenshift/EE0000',
  },
  ...
  {
    label: 'GeeksForGeeks',
    url: 'https://cdn.simpleicons.org/geeksforgeeks/2F8D46',
  },
  {
    label: 'PyCharm',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/pycharm/pycharm-original.svg',
  },
  ...
  {
    label: 'Gradle',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/gradle/gradle-original.svg',
  },
  { label: 'Hibernate', url: 'https://cdn.simpleicons.org/hibernate/59666C' },
  { label: 'JUnit', url: 'https://cdn.simpleicons.org/junit5/25A162' },
  {
    label: 'Tomcat',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tomcat/tomcat-original.svg',
  },
  {
    label: 'IntelliJ IDEA',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/intellij/intellij-original.svg',
  },
  // JavaScript packages
  ...
  {
    label: 'Yarn',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/yarn/yarn-original.svg',
  },
  ...
  {
    label: 'Anaconda',
    url: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/anaconda/anaconda-original.svg',
  },
...
const S = {
  ...
  iconPickerItem: (sel: boolean) =>
    ({
      background: sel ? '#2bff88' : '#252525',
      border: `1px solid ${sel ? '#2bff88' : '#333'}`,
      borderRadius: '6px',
      padding: '4px 8px',
      cursor: 'pointer',
      display: 'flex',
...
export default function AdminResume() {
  ...
  const [iconPickerTarget, setIconPickerTarget] = useState<{
    section: 'key' | 'other' | 'hobbies';
    idx: number;
  } | null>(null);
  const [certBulletPicker, setCertBulletPicker] = useState<{
    certIdx: number;
    bIdx: number;
  } | null>(null);
  ...
  function addSkill(section: 'key' | 'other' | 'hobbies') {
    ...
    setData((d) => ({
      ...
      [key]: [
        ...((d[key] as Skill[]) || []),
        { text: '', iconUrl: '/assets/portfolio/skills/check.svg' },
      ],
    }));
  }
  ...
  function removeSkill(section: 'key' | 'other' | 'hobbies', idx: number) {
    ...
    setData((d) => ({
      ...d,
      [key]: ((d[key] as Skill[]) || []).filter((_, i) => i !== idx),
    }));
  }
  ...
  function addResp(expIdx: number) {
    setData((d) => {
      ...
      arr[expIdx] = {
        ...arr[expIdx],
        responsibilities: [
          ...(arr[expIdx].responsibilities || []),
          { text: '', iconUrl: '/assets/portfolio/check.svg' },
        ],
      };
      return { ...d, experience: arr };
    });
  ...
  function removeResp(expIdx: number, respIdx: number) {
    setData((d) => {
      ...
      exps[expIdx] = {
        ...exps[expIdx],
        responsibilities: exps[expIdx].responsibilities.filter(
          (_, i) => i !== respIdx
        ),
      };
      return { ...d, experience: exps };
  ...
  function removeCertBullet(certIdx: number, bIdx: number) {
    setData((d) => {
      ...
      arr[certIdx] = {
        ...arr[certIdx],
        bullets: arr[certIdx].bullets.filter((_, i) => i !== bIdx),
      };
      return { ...d, certifications: arr };
    });
  }

  function setCertBullet(
    certIdx: number,
    bIdx: number,
    field: keyof Responsibility,
    value: string
  ...
  function addNonTechGroup() {
    setData((d) => ({
      ...d,
      nonTechSkills: [...(d.nonTechSkills || []), { category: '', items: [] }],
    }));
  }
  ...
  function removeNonTechGroup(gi: number) {
    setData((d) => ({
      ...d,
      nonTechSkills: (d.nonTechSkills || []).filter((_, i) => i !== gi),
    }));
  }
      ...
      <div style={S.page}>
        ...
        <div style={S.content}>
          ...
          <p style={S.sectionSub}>
            Edit every section of your resume. Changes are saved to the database
            ...
            <div style={S.grid2}>
              ...
              <div style={S.formRow}>
                ...
                <input
                  ...
                  value={pi.suffix}
                  autoComplete="off"
                  onChange={(e) => setPI('suffix', e.target.value)}
              ...
              <div style={S.formRow}>
                ...
                <input
                  style={S.input}
                  value={pi.title}
                  onChange={(e) => setPI('title', e.target.value)}
              ...
              <div style={S.formRow}>
                ...
                <input
                  style={S.input}
                  value={pi.linkedinUrl}
                  onChange={(e) => setPI('linkedinUrl', e.target.value)}
              ...
              <div style={S.formRow}>
                ...
                <input
                  style={S.input}
                  value={pi.githubUrl}
                  onChange={(e) => setPI('githubUrl', e.target.value)}
              ...
              <div style={S.formRow}>
                ...
                <input
                  style={S.input}
                  value={pi.cvPdfUrl}
                  onChange={(e) => setPI('cvPdfUrl', e.target.value)}
                  placeholder="/assets/your-cv.pdf or https://..."
                />
                <p style={S.hint}>
                  Upload your PDF to the public/assets/ folder and enter the
                  path here
                </p>
              </div>
            </div>
          ...
          <div style={S.card}>
                ...
                <div key={idx}>
                  <div style={S.skillItem}>
                    ...
                    <input
                      ...
                      value={skill.text}
                      onChange={(e) =>
                        setSkill('key', idx, 'text', e.target.value)
                      }
                      placeholder="Skill name"
                    />
                    <input
                      style={{ ...S.smallInput, width: '130px' }}
                      value={skill.iconUrl}
                      onChange={(e) =>
                        setSkill('key', idx, 'iconUrl', e.target.value)
                      }
                      placeholder="/assets/..."
                    />
                    <button
                      ...
                      onClick={() => {
                        setIconPickerTarget(
                          iconPickerTarget?.section === 'key' &&
                            iconPickerTarget.idx === idx
                            ? null
                            : { section: 'key' as const, idx }
                        );
                      }}
                    >
                      Browse...
                  ...
                  {iconPickerTarget?.section === 'key' &&
                    iconPickerTarget.idx === idx && (
                      ...
                      >
                        ...
                        >
                          <div
                            style={S.iconPickerItem(
                              skill.iconUrl ===
                                '/assets/portfolio/skills/check.svg'
                            )}
                            onClick={() =>
                              pickIcon(
                                'key',
                          ...
                          {SKILL_ICONS.map((ic) => (
                            <div
                              key={ic.url}
                              style={S.iconPickerItem(skill.iconUrl === ic.url)}
                              onClick={() => pickIcon('key', idx, ic.url)}
                            >
                              <img
                                src={ic.url}
                                alt={ic.label}
            ...
            <button style={S.addRowBtn} onClick={() => addSkill('key')}>
              + Add Skill
            </button>
          </div>
          ...
          <div style={S.card}>
                ...
                <div key={idx}>
                  <div style={S.skillItem}>
                    ...
                    <input
                      ...
                      value={skill.text}
                      onChange={(e) =>
                        setSkill('other', idx, 'text', e.target.value)
                      }
                      placeholder="Skill name"
                    />
                    <input
                      ...
                      value={skill.iconUrl}
                      onChange={(e) =>
                        setSkill('other', idx, 'iconUrl', e.target.value)
                      }
                      placeholder="/assets/..."
                    />
                    <button
                      ...
                      onClick={() => {
                        setIconPickerTarget(
                          iconPickerTarget?.section === 'other' &&
                            iconPickerTarget.idx === idx
                            ? null
                            : { section: 'other' as const, idx }
                        );
                      }}
                    >
                      Browse...
                        ...
                        >
                          ...
                          {SKILL_ICONS.map((ic) => (
                            <div
                              key={ic.url}
                              style={S.iconPickerItem(skill.iconUrl === ic.url)}
                              onClick={() => pickIcon('other', idx, ic.url)}
                            >
                              <img
                                src={ic.url}
                                alt={ic.label}
            ...
            <button style={S.addRowBtn} onClick={() => addSkill('other')}>
              + Add Skill
            </button>
          </div>
          ...
          <div style={S.card}>
            ...
            <p style={{ ...S.hint, marginBottom: '12px' }}>
              Group skills into categories (e.g. Communication, Leadership).
              Displayed as tags on the resume.
            </p>
            {(data.nonTechSkills || []).map((group, gi) => (
              <div key={gi} style={{ ...S.expCard, marginBottom: '10px' }}>
                <div style={S.expHeader}>
                  ...
                  <button
                    style={{ ...S.removeBtn, marginLeft: '8px' }}
                    onClick={() => removeNonTechGroup(gi)}
                  >
                    Remove Group
                  </button>
                </div>
                  ...
                  {group.items.map((item, ii) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() => removeNonTechItem(gi, ii)}
                      >
                        ×
                      </button>
                    </div>
            ...
            <button style={S.addRowBtn} onClick={addNonTechGroup}>
              + Add Category
            </button>
          </div>
          ...
          <div style={S.card}>
            ...
            <p style={{ ...S.hint, marginBottom: '12px' }}>
              Displayed in the left sidebar below Non-Technical Skills. Use the
              bullet icon for a clean look, or pick any skill icon.
            </p>
            <div style={S.skillList}>
                ...
                <div key={idx}>
                  <div style={S.skillItem}>
                    ...
                    <input
                      ...
                      value={hobby.text}
                      onChange={(e) =>
                        setSkill('hobbies', idx, 'text', e.target.value)
                      }
                    ...
                    <input
                      ...
                      value={hobby.iconUrl}
                      onChange={(e) =>
                        setSkill('hobbies', idx, 'iconUrl', e.target.value)
                      }
                      placeholder="/assets/..."
                    />
                    <button
                      ...
                      onClick={() => {
                        setIconPickerTarget(
                          iconPickerTarget?.section === 'hobbies' &&
                            iconPickerTarget.idx === idx
                            ? null
                            : { section: 'hobbies' as const, idx }
                        );
                      }}
                    >
                      Browse...
                    ...
                    <button
                      style={S.removeBtn}
                      onClick={() => removeSkill('hobbies', idx)}
                    >
                      Remove
                    </button>
                  </div>
                      ...
                      >
                        ...
                        >
                          <div
                            style={S.iconPickerItem(
                              hobby.iconUrl ===
                                '/assets/portfolio/bullets/check.svg'
                            )}
                            onClick={() =>
                              pickIcon(
                                'hobbies',
                          ...
                          {BULLET_ICONS.map((ic) => (
                            <div
                              key={ic.url}
                              style={S.iconPickerItem(hobby.iconUrl === ic.url)}
                              onClick={() => pickIcon('hobbies', idx, ic.url)}
                            >
                              <img
                                src={ic.url}
                                alt={ic.label}
            ...
            <button style={S.addRowBtn} onClick={() => addSkill('hobbies')}>
              + Add Hobby
            </button>
          </div>
          ...
          <div style={S.card}>
            ...
            <div style={S.formRow}>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setData((d) => ({ ...d, experienceIntro: e.target.value }))
                }
                placeholder="I've worked on a handful of projects, some of which were for the following organizations:"
              />
              <p style={S.hint}>
                This sentence appears above the experience list on your resume.
              </p>
            </div>
            {data.experience.map((exp, expIdx) => (
              <div key={expIdx} style={S.expCard}>
                <div style={S.expHeader}>
                  ...
                  <button style={S.removeBtn} onClick={() => removeExp(expIdx)}>
                    Remove
                  </button>
                </div>
                <div style={S.grid2}>
                  <div style={S.formRow}>
                    ...
                    <input
                      ...
                      value={exp.company}
                      onChange={(e) =>
                        setExp(expIdx, 'company', e.target.value)
                      }
                      placeholder="Company"
                    />
                  </div>
                  <div style={S.formRow}>
                    ...
                    <input
                      style={S.smallInput}
                      value={exp.companyImg}
                      onChange={(e) =>
                        setExp(expIdx, 'companyImg', e.target.value)
                      }
                      placeholder="/assets/portfolio/logo.png"
                    />
                    <p style={S.hint}>
                      Upload logo to public/assets/portfolio/ then enter path
                    </p>
                  </div>
                  <div style={S.formRow}>
                    ...
                    <input
                      style={S.smallInput}
                      value={exp.role}
                      onChange={(e) => setExp(expIdx, 'role', e.target.value)}
                  ...
                  <div style={S.formRow}>
                    ...
                    <input
                      ...
                      value={exp.timeFrame}
                      onChange={(e) =>
                        setExp(expIdx, 'timeFrame', e.target.value)
                      }
                ...
                <div style={S.formRow}>
                  ...
                  <textarea
                    ...
                    value={exp.shortSummary}
                    onChange={(e) =>
                      setExp(expIdx, 'shortSummary', e.target.value)
                    }
                  ...
                  {(exp.responsibilities || []).map((resp, respIdx) => (
                    <div key={respIdx} style={S.respItem}>
                      <select
                        ...
                        value={resp.iconUrl}
                        onChange={(e) =>
                          setResp(expIdx, respIdx, 'iconUrl', e.target.value)
                        }
                      >
                        <option value="/assets/portfolio/check.svg">
                          ✓ Check
                        </option>
                        <option value="/assets/portfolio/star.svg">
                          ★ Star
                        </option>
                        <option value="/assets/portfolio/quote.svg">
                          " Quote
                        </option>
                      </select>
                      <input
                        ...
                        value={resp.text}
                        onChange={(e) =>
                          setResp(expIdx, respIdx, 'text', e.target.value)
                        }
                      ...
                      <input
                        ...
                        value={resp.url || ''}
                        onChange={(e) =>
                          setResp(expIdx, respIdx, 'url', e.target.value)
                        }
                        placeholder="Optional link URL"
                      />
                      <button
                        style={S.removeBtn}
                        onClick={() => removeResp(expIdx, respIdx)}
                      >
                        ×
                      </button>
                    </div>
                  ))}
                  <button style={S.addRowBtn} onClick={() => addResp(expIdx)}>
                    + Add Responsibility
                  </button>
                </div>
              </div>
            ))}
            <button style={S.addRowBtn} onClick={addExp}>
              + Add Experience
            </button>
          </div>
          ...
          <div style={S.card}>
            ...
            {data.education.map((edu, idx) => (
              <div key={idx} style={{ ...S.expCard, marginBottom: '10px' }}>
                <div style={S.expHeader}>
                  ...
                  <button style={S.removeBtn} onClick={() => removeEdu(idx)}>
                    Remove
                  </button>
                </div>
                <div style={S.grid2}>
                  ...
                  <div style={S.formRow}>
                    ...
                    <input
                      style={S.smallInput}
                      value={edu.field}
                      onChange={(e) => setEdu(idx, 'field', e.target.value)}
                  ...
                  <div style={S.formRow}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEdu(idx, 'institution', e.target.value)
                      }
                  ...
                  <div style={S.formRow}>
                    ...
                    <input
                      style={S.smallInput}
                      value={edu.duration || ''}
                      onChange={(e) => setEdu(idx, 'duration', e.target.value)}
                  ...
                  <div style={S.formRow}>
                    ...
                    <input
                      style={S.smallInput}
                      value={edu.cgpa || ''}
                      onChange={(e) => setEdu(idx, 'cgpa', e.target.value)}
                      placeholder="8.5/10"
                    />
                  </div>
                  <div style={S.formRow}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEdu(idx, 'percentage', e.target.value)
                      }
                      placeholder="78.5"
                    />
                  </div>
            ...
            <button style={S.addRowBtn} onClick={addEdu}>
              + Add Education
            </button>
          </div>
          ...
          <div style={S.card}>
            ...
            {(data.certifications || []).map((cert, idx) => (
              <div key={idx} style={{ ...S.expCard, marginBottom: '10px' }}>
                <div style={S.expHeader}>
                  <strong style={{ fontSize: '0.85rem' }}>
                    {cert.certificationName || `Certification ${idx + 1}`}
                  </strong>
                  <button style={S.removeBtn} onClick={() => removeCert(idx)}>
                    Remove
                  </button>
                </div>
                <div style={S.grid2}>
                  <div style={S.formRow}>
                    ...
                    <input
                      style={S.smallInput}
                      value={cert.company}
                      onChange={(e) => setCert(idx, 'company', e.target.value)}
                  ...
                  <div style={{ ...S.formRow, gridColumn: 'span 2' }}>
                    ...
                    >
                      ...
                      <input
                        ...
                        value={cert.companyImg || ''}
                        onChange={(e) =>
                          setCert(idx, 'companyImg', e.target.value)
                        }
                        placeholder="/assets/portfolio/skills/aws.svg or CDN URL"
                      />
                    </div>
                    <p style={S.hint}>
                      Upload logo to public/assets/portfolio/ then enter path,
                  ...
                  <div style={S.formRow}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCert(idx, 'certificationName', e.target.value)
                      }
                  ...
                  <div style={S.formRow}>
                    ...
                    <input
                      style={S.smallInput}
                      value={cert.timeFrame}
                      onChange={(e) =>
                        setCert(idx, 'timeFrame', e.target.value)
                      }
                  ...
                  <div style={S.formRow}>
                    ...
                    <input
                      style={S.smallInput}
                      value={cert.url || ''}
                      onChange={(e) => setCert(idx, 'url', e.target.value)}
                  ...
                  <div style={{ ...S.formRow, gridColumn: 'span 2' }}>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setCert(idx, 'description', e.target.value)
                      }
                    ...
                    <div key={bIdx} style={{ marginBottom: '8px' }}>
                      ...
                      >
                        ...
                        <input
                          ...
                          value={b.text}
                          onChange={(e) =>
                            setCertBullet(idx, bIdx, 'text', e.target.value)
                          }
                        ...
                        <button
                          ...
                          onClick={() => {
                            const same =
                              certBulletPicker?.certIdx === idx &&
                              certBulletPicker.bIdx === bIdx;
                            setCertBulletPicker(
                              same ? null : { certIdx: idx, bIdx }
                            );
                            setCertBulletSearch('');
                          }}
                        >
                        ...
                        <input
                          style={{ ...S.smallInput, width: '160px' }}
                          value={b.url || ''}
                          onChange={(e) =>
                            setCertBullet(idx, bIdx, 'url', e.target.value)
                          }
                          placeholder="Link URL (optional)"
                        />
                        <button
                          style={S.removeBtn}
                          onClick={() => removeCertBullet(idx, bIdx)}
                        >
                          ✕
                        </button>
                      </div>
                        ...
                        certBulletPicker.bIdx === bIdx && (
                          ...
                          >
                            <input
                              ...
                              value={certBulletSearch}
                              onChange={(e) =>
                                setCertBulletSearch(e.target.value)
                              }
                            ...
                            >
                              <div
                                ...
                                onClick={() => {
                                  ...
                                  setCertBulletPicker(null);
                                }}
                              >
                                <span style={{ fontSize: '1rem' }}>✓</span>{' '}
                                Bullet
                              </div>
                              {BULLET_ICONS.filter((ic) =>
                                ic.label
                                  .toLowerCase()
                                  .includes(certBulletSearch.toLowerCase())
                              ).map((ic) => (
                                <div
                                  key={ic.url}
                                  style={S.iconPickerItem(b.iconUrl === ic.url)}
                                  onClick={() => {
                                    setCertBullet(idx, bIdx, 'iconUrl', ic.url);
                                    setCertBulletPicker(null);
                                  }}
                                >
                                  <img
            ...
            <button style={S.addRowBtn} onClick={addCert}>
              + Add Certification
            </button>
          </div>
        ...
        <div style={S.saveBar}>
          ...
          {status && (
            <span
              style={{
                ...S.status,
                color: status.includes('success') ? '#2bff88' : '#ff4d4d',
              }}
            >
              {status}
            </span>
