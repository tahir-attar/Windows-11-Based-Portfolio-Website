...
export default function AdminAbout() {
  ...
  function removeBox(boxId: string) {
    setData((d) => ({
      ...d,
      skillBoxes: d.skillBoxes.filter((b) => b.id !== boxId),
    }));
  }
  ...
  function removeIcon(boxId: string, iconUrl: string) {
    setData((d) => ({
      ...
      skillBoxes: d.skillBoxes.map((b) =>
        b.id === boxId
          ? { ...b, icons: b.icons.filter((i) => i.iconUrl !== iconUrl) }
          : b
      ),
    }));
  }
  ...
  return (
    <>
      <Head>
        <title>About Skills — Admin</title>
      </Head>
      <div style={S.page}>
        ...
        <div style={S.content}>
          ...
          <p style={S.sectionSub}>
            Manage the Skills section that appears on your About page. Changes
          ...
          <div style={S.card}>
            ...
            >
              The header "Skills" is fixed. You can update the subtitle below.
            </p>
            <div style={S.formRow}>
              ...
              <input
                ...
                onChange={(e) =>
                  setData((d) => ({ ...d, subtitleText: e.target.value }))
                }
          ...
          <div style={S.card}>
            ...
            >
              Each box appears as a glass card. Two boxes per row — the third
              automatically wraps to a new row with the same light effects.
            </p>
            ...
            {data.skillBoxes.map((box, idx) => {
              ...
              return (
                <div key={box.id} style={S.boxCard}>
                  ...
                  <div style={S.formRow}>
                    <label style={S.label}>
                      Box Header (e.g. Frontend, Backend)
                    </label>
                    <input
                      style={S.input}
                      value={box.header}
                  ...
                  <div style={S.formRow}>
                    ...
                    >
                      Search and click to toggle icons. Selected icons appear
                      with the animated hover label on the live site.
                    </p>
                        ...
                        {box.icons.map((ic) => (
                          <div key={ic.iconUrl} style={S.selectedIcon}>
                            ...
                            <button
                              ...
                              onClick={() => removeIcon(box.id, ic.iconUrl)}
                            >
                              ✕
                            </button>
                          </div>
                  ...
                  <div style={S.formRow}>
                    <label style={S.label}>
                      Tech Skills List (green title on left, white content on
                      right)
                    </label>
                    {box.techSkills.map((ts) => (
                      <div key={ts.id} style={S.techRow}>
                        ...
                        <input
                          ...
                          value={ts.value}
                          onChange={(e) =>
                            setTechSkill(box.id, ts.id, 'value', e.target.value)
                          }
                          placeholder="JavaScript, TypeScript"
                        />
                        <button
                          style={S.removeBtn}
                          onClick={() => removeTechSkill(box.id, ts.id)}
                        >
                          ✕
                        </button>
                      </div>
            ...
            <button style={S.addBoxBtn} onClick={addBox}>
              + Add Skill Box
            </button>
          </div>
        </div>
