  ...
  const recommendedFiles: IRecommendedFile[] = [
    {
      ...
      icon: '/assets/icons/startmenu/linkedin.svg',
      action: () => window.open('https://www.linkedin.com/in/tahir-attar', '_blank'),
    ...
    },
    {
      id: 5,
      fileName: 'X',
      details: 'Connect on X',
      icon: '/assets/icons/recommended/x.svg',
      action: () => window.open('https://x.com/tahir_attar1109', '_blank'),
      iconSize: { height: 40, width: 40 },
      willOpenWindowWith: null,
    },
    {
